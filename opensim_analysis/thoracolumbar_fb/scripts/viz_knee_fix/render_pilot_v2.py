...
def recolor(cond):
    for nm,(ob,mat) in muscle_objs.items():
        ...
        if "Emission Strength" in b.inputs: b.inputs["Emission Strength"].default_value=0.25+2.6*n
