...
def kp(t):
    ...
    return P_stand
rows=[]
# wrist is now NEUTRAL at grasp (flex~-1, dev~0; palm dir via pro_sup~-12) -> small values
# interpolate smoothly over the full reach with no gate needed (no wrist roll).
for t in ts:
