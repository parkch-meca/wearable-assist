...
tb.data.materials.append(smat("table",(0.55,0.57,0.66),0.05,0.45)); tb.name="TABLE"; force_vis(tb)
...
tt=bpy.context.object; tt.scale=(Dx, 0.02, Dz); tt.data.materials.append(smat("ttop",(0.62,0.64,0.72),0.2,1.0)); tt.name="TTOP"; force_vis(tt)
...
mx=[max(bonemax[0],EDGE+Dx+0.05), max(bonemax[1],TOP+0.32), max(bonemax[2],Dz/2)]
