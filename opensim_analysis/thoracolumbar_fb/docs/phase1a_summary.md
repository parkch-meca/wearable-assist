...
### (3.5) Suit dose-response 검증 — Moco confirms SO §1.6

5조건 sweep (F=0/50/100/150/200 N, T=0/6/12/18/24 N·m) Moco 결과:

| 지표 | Slope (%/Nm) | R² | red @ 24 Nm | vs SO 1.206 |
|---|---:|---:|---:|---:|
| **Moco ES_mean Hold** | **1.164** | 1.0000 | **27.95 %** | **−1.0 %p, 차이 −3.5 %** |
| Moco ES_mean Concentric | 1.186 | 1.0000 | 28.46 % | −0.5 %p, 차이 −1.7 % |
| Moco IL_R10_r Hold | 1.603 | 1.0000 | 38.49 % | dominant muscle |
| **SO §1.6 ref (R100)** | **1.206** | 1.000 | **28.97 %** | — |

→ **SO와 Moco 두 독립 수단이 같은 dose-response 결론**. 논문 §1.6 헤드라인 안전.
