# CONTINUATION_GUIDE — Historical Archive

Appended older versions of CONTINUATION_GUIDE.md here (newest entry at top).

---

## Entry: 2026-04-22 (superseded 2026-04-24)

Snapshot of `/data/CONTINUATION_GUIDE.md` as it stood at end of session 2026-04-22, before being replaced by the Moco-transition guide on 2026-04-24. Preserved for traceability of pre-Moco project state.
